            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="control-label col-md-3">Nama Pariwisata</div>
                        <div class="col-md-8">
                            <input type="text" id="nama_pariwisata" class="form-control" name="nama_pariwisata">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?php
                            $dropdown = getDropdownList('kategori', ['nama_kategori', 'nama_kategori'], 'Kategori Pariwisata');
